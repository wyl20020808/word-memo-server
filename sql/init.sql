-- 创建数据库
CREATE DATABASE IF NOT EXISTS word_memo CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- 插入示例单词数据
INSERT IGNORE INTO words (word, phonetic, translation, example, category) VALUES
